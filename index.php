...
<body>
            ...
            <div class="fb-home-timeline">
                ...
                <div class="create-post">
                    <div class="create-post-header">
                        <img src="./assets/images/user.png" alt="" />
                        <button data-bs-toggle="modal" data-bs-target="#postModal">Whats on your mind ?</button>
                    </div>
    ...
    <!-- comment replay modal start -->
    <div class="modal fade zindex" id="commentReplayModal">
                    ...
                    <form id="replay-comment-form" action="" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="comment-rep-name" type="text" placeholder="Your Name"
                                name="comm_rep_usr_name" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label label-text" for="comment-rep-content">Comment</label>
                            <textarea class="form-control" name="comment-rep-content"
                                id="comment-rep-content"></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="commenter-rep-photo">Commenter Profile Photo</label>
                            <input id="commenter-rep-photo" class="form-control" required type="file"
    ...
    <!-- comment replay modal end -->


    <!-- comment modal start -->
    <div class="modal fade zindex" id="commentModal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title fs-5">Comment</h2>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <div class="modal-body">

                    <form id="insert_comment" action="" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label class="form-label" for="comment-name">Comment Name</label>
                            <input class="form-control" id="comment-name" type="text" placeholder="Your Name"
                                name="comm_usr_name" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label label-text" for="comment-content">Comment</label>
                            <textarea class="form-control" name="comment_content" id="comment-content"></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="commenter-photo">Commenter Profile Photo</label>
                            <input id="commenter-photo" class="form-control" required type="file"
                        ...
                        <div class="mb-3">
                            ...
                            <input id="comment-images" class="form-control" type="file" name="comment_photos">
                        </div>

                        <div class="mb-3">
                            <label class="form-label" for="comment-rep-images">Comment Video</label>
                            <input id="comment-rep-video" class="form-control" type="file" name="comment_video">
                        </div>

                        <div class="mb-3">
                            <input class="btn btn-primary" type="submit" name="comment-submit" value="Create Comment">
                        </div>
                    </form>
                </div>
            </div>
    ...
    <!-- post modal start -->
    <div class="modal fade zindex" id="postModal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title fs-5">What On your Mind!</h2>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <div class="modal-body">

                    <form id="insert_post" action="" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label class="form-label" for="poster-name">Poster Name</label>
                            <input class="form-control" id="poster-name" type="text" placeholder="Your Name" name="name"
                                required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label label-text" for="post-content">Post Content</label>
                            <textarea class="form-control" name="post-content" id="post-content"></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="poster-photo">Poster Profile Photo</label>
                            <input id="poster-photo" class="form-control" required type="file" name="p_photo">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="poster-images">Images</label>
                            <input id="poster-images" class="form-control" type="file" multiple name="posts_photos[]">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="poster-video">Video</label>
                            <input id="poster-video" class="form-control" type="file" multiple name="post_video[]">
                        </div>
                        <div class="mb-3">
                            <input class="btn btn-primary" type="submit" name="post-submit" value="Post">
                        </div>
                    </form>
                </div>
            </div>
